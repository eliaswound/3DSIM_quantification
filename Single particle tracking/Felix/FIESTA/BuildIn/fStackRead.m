function [Stack,TiffInfo,MetaInfo,StackInfo] = fStackRead(source)
...
workbar(0,'Reading Stack Information...','Progress',0);  
...
workbar(0,'Reading Stack...','Progress',0);                
Stack = cell(1,N);                
for n = 1:N
    x = ImageWidth(1,n);
    y = ImageLength(1,n);
