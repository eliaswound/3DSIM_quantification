...
%
%   X = LSQNONLIN(PROBLEM) solves the non-linear least squares problem defined in
%   PROBLEM. PROBLEM is a structure with the function FUN in PROBLEM.objective,
%   the start point in PROBLEM.x0, the lower bounds in PROBLEM.lb, the upper 
%   bounds in PROBLEM.ub, the options structure in PROBLEM.options, and solver 
%   name 'lsqnonlin' in PROBLEM.solver. Use this syntax to solve at the command 
%   line a problem exported from OPTIMTOOL. The structure PROBLEM must have all 
%   the fields. 
%
...
%             x(1) - x(2) ];
%
%   To solve the least squares problem for a specific value of c, first assign 
...
%   $Revision: 1.1.6.1 $  $Date: 2006/11/11 22:46:29 $
