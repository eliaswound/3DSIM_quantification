...
for i=1:ListLength
    ...
    set(hMainGui.LeftPanel.pRegions.RegList.Region(i),'Enable','on','ForegroundColor',hMainGui.Region(i+ListBegin).color,'UIContextMenu',hMainGui.Menu.ctRegion,'String',['Region ' num2str(i+ListBegin)]);
end
