...
hMenu.mOpenStack = uimenu('Parent',hMenu.mData,'Callback','fMenuData(''OpenStack'',getappdata(0,''hMainGui''));',...
                          'Label','Open Metamorph Stack','Tag','mOpenStack','Accelerator','S','UserData','MetaMorph');
                        
hMenu.mOpenTiff = uimenu('Parent',hMenu.mData,'Callback','fMenuData(''OpenStack'',getappdata(0,''hMainGui''));',...
                         'Label','Open Multilayer Tiff','Tag','mOpenTiff','Accelerator','T','UserData','TIFF');
...
hMenu.mAddStackServer = uimenu('Parent',hMenu.mEdit,'Callback','fShared(''AddStack'',getappdata(0,''hMainGui''));','Enable','off',...
                               'Label','Add Stack to SERVER Queue','Tag','mAddStackServer','UserData','Server');
...
hMenu.mMergeTracks = uimenu('Parent',hMenu.mEdit,'Callback','fShared(''MergeTracks'',getappdata(0,''hMainGui''));','Enable','off',...
                    'Label','Merge Selection','Tag','mMergeTracks','Accelerator','M','Separator','on');

hMenu.mDeleteTracks = uimenu('Parent',hMenu.mEdit,'Callback','fShared(''DeleteTracks'',getappdata(0,''hMainGui''),[],[]);','Enable','off',...
                       'Label','Delete Selection','Tag','mDeleteTracks','Accelerator','X');
...
hMenu.mConfig = uimenu('Parent',hMenu.mOptions,'Callback','fConfigGui(''Create'',getappdata(0,''hMainGui''));',...
...
hMenu.mMolToFil = uimenu('Parent',hMenu.mStats,'Callback','fMenuStatistics(''MolToFil'',getappdata(0,''hMainGui''));',...
                          'Label','Molecule distance to filament','Tag','mMolToFil');

hMenu.mPathStats = uimenu('Parent',hMenu.mStats,'Callback','fPathStatsGui(''Create'');',...
                            'Label','Path Statistics','Tag','PathStats');
                        
hMenu.mAverageSpeed = uimenu('Parent',hMenu.mStats,'Callback','fAverageSpeedGui(''Create'');',...
                             'Label','Average Speed','Tag','mAverageSpeed ');                        
                        
hMenu.mMSD = uimenu('Parent',hMenu.mStats,'Callback','fMenuStatistics(''MSD'',getappdata(0,''hMainGui''));',...
                    'Label','Mean square displacement','Tag','mMSD');                                                
                        
%create Help menu
hMenu.mHelp = uimenu('Parent',hMainGui.fig,'Label','Help','Tag','mHelp');

hMenu.mGeneralHelp = uimenu('Parent',hMenu.mHelp,'Label','Help','Tag','mGeneralHelp','Callback','openhelp');

hMenu.mHowToMol = uimenu('Parent',hMenu.mHelp,'Label','How to track molecules','Tag','mHowToMol','Separator','on','Callback','openhelp(''content\HowTo\Track molecules.htm'');');

hMenu.mHowToFil = uimenu('Parent',hMenu.mHelp,'Label','How to track micortubules','Tag','mHowToFil','Callback','openhelp(''content\HowTo\Track microtubules.htm'');');

hMenu.mHowToDual = uimenu('Parent',hMenu.mHelp,'Label','How to use dual color','Tag','mHowToDual','Callback','openhelp(''content\HowTo\Dual color tracking.htm'');');

hMenu.mAbout = uimenu('Parent',hMenu.mHelp,'Callback','fAboutGui(getappdata(0,''hMainGui''));',...
                      'Label','About','Tag','mAbout','Separator','on');
...
for i=1:2
    ...
    hMenu.ctTrack(i).menu = uicontextmenu('Parent',hMainGui.fig);
    ...
    hMenu.ctTrack(i).Mark.mBlue = uimenu('Parent',hMenu.ctTrack(i).mMark,'Callback','fMenuContext(''MarkTrack'');',...
                                    'Label','Blue','Tag','mBlue','UserData',[0 0 1]);       

    hMenu.ctTrack(i).Mark.mGreen = uimenu('Parent',hMenu.ctTrack(i).mMark,'Callback','fMenuContext(''MarkTrack'');',...
                                    'Label','Green','Tag','mGreen','UserData',[0 1 0]);   

    hMenu.ctTrack(i).Mark.mRed = uimenu('Parent',hMenu.ctTrack(i).mMark,'Callback','fMenuContext(''MarkTrack'');',...
                                    'Label','Red','Tag','mRed','UserData',[1 0 0]);              

    hMenu.ctTrack(i).Mark.mPink = uimenu('Parent',hMenu.ctTrack(i).mMark,'Callback','fMenuContext(''MarkTrack'');',...
                                      'Label','Pink','Tag','mPink ','UserData',[1 0.5 0.5]);                             

    hMenu.ctTrack(i).Mark.mOrange = uimenu('Parent',hMenu.ctTrack(i).mMark,'Callback','fMenuContext(''MarkTrack'');',...
                                      'Label','Orange','Tag','mOrange','UserData',[1 0.5 0]);                                                           

    hMenu.ctTrack(i).Mark.mYellow = uimenu('Parent',hMenu.ctTrack(i).mMark,'Callback','fMenuContext(''MarkTrack'');',...
                                      'Label','Yellow','Tag','mYellow ','UserData',[1 1 0]);                             
...
hMenu.ListFil.mMerge = uimenu('Parent',hMenu.ctListFil,'Callback','fShared(''MergeTracks'',getappdata(0,''hMainGui''));',...
                                'Label','Merge Selection','Separator','on','Tag','mMergeFil','UserData','Filament');
...
hMenu.ListLoc.mDelete = uimenu('Parent',hMenu.ctListLoc,'Callback','fMenuContext(''DeleteQueue'',getappdata(0,''hMainGui''));',...
                                'Label','Delete Selection','Tag','mDelete ','UserData','Selected');
                            
hMenu.ListLoc.mDeleteAll = uimenu('Parent',hMenu.ctListLoc,'Callback','fMenuContext(''DeleteQueue'',getappdata(0,''hMainGui''));',...
