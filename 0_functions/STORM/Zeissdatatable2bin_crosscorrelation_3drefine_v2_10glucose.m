...
if z(i)<0
    switch d
        case d<1600
        z_sphericalabberationcorrected(i,1)=z(i)*0.79*0.9;
        case d>=1600&d<2300
        z_sphericalabberationcorrected(i,1)=z*0.79*0.95;
        case d>=2300
        z_sphericalabberationcorrected(i,1)=z*0.79*1;
    end 
else
        z_sphericalabberationcorrected(i,1)=z*0.79*(1+0.7*d/1000); 
end
end
