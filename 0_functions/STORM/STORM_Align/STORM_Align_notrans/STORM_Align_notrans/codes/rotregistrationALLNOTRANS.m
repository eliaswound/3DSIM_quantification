...
function [aligniter,iterIm,s,n_frame,allIm] = rotregistrationALLNOTRANS(images,usfac,angrange,angstep,n_iteration)
...
for iter = 1:n_iteration
        ...
        for k=1:n_frame;
            ...
            [Greg,row_shift,col_shift,Angle] = rotregistrationNOTRANS(ft1,ft2,usfac,angrange,angstep);
