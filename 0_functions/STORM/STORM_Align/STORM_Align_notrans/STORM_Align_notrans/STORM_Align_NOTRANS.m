function STORM_Align_NOTRANS(file,folder,zoom)
...
n_iteration = 3;  % number of iterations you wanted to align, increase this number if the result is not satisfying.
...
[aligniter,iterIm,s,n_frame,allIm] = rotregistrationALLNOTRANS(images0,usfac,angrange,angstep,n_iteration);

writelist10NOTRANS(aligniter,n_iteration,file,zoom);
