...
if z(i,1)<0
     if d<1600
        z_sphericalabberationcorrected(i,1)=z(i,1)*0.79*0.9;
     elseif d>=1600&&d<2300
        z_sphericalabberationcorrected(i,1)=z(i,1)*0.79*0.95;
     else 
        z_sphericalabberationcorrected(i,1)=z(i,1)*0.79*1;
     end 
else
        z_sphericalabberationcorrected(i,1)=z(i,1)*0.79*(1+0.7*d/1000); 
end
end
...
moleculelist.a=single(data(:,10)-data(:,11));
