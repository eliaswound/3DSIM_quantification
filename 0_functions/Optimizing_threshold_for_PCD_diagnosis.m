...
for j=1:length(files)
    ...
    threshold_green=50:50:1000;
    for u=1:length(threshold_green)
        display('threshold')
        display(num2str(u))
        display('underanalysis')
        red_pixel_sum=0;
        red_intensity_sum=0;
        green_pixel_sum=0;
        ...
        for i=1:data.num_images/2
            ...
            % threshold
            red_index_refer=find(red_temp(data.InboundaryIndexlist_red)>data.threshold_red);
            ...
            % threshold
            green_index_refer=find(green_temp(data.InboundaryIndexlist_green)>threshold_green(u));
    ...
    % data saving
    %--------------------------------------------------------------------------
   temp.threshold=[data.threshold_red,threshold_green(u)];
